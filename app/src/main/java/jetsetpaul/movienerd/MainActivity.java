...
//        setSupportActionBar(myToolbar);
    ...
    public void onSubfilterClicked(String selectedParams) {
        ...
        }else if(selectedFilter.getmCategory().equals("Popularity")){
            myParams.setPopularity(selectedParams);
    ...
    public static HashMap<String, String> parsePopularityArray(int stringArrayResourceId, Context context){
        String[] stringArray = context.getResources().getStringArray(stringArrayResourceId);
        HashMap<String, String> outputArray = new HashMap<>(stringArray.length);
        for (String entry : stringArray){
            String [] splitResult = entry.split("\\|", 2);
    ...
    public void discoverTMDB(){
        ...
        HashMap<String, String> myPopularityArray = parsePopularityArray(R.array.tmdb_popularity_values, this);
        if(myParams!= null){
            ...
            }if(myPopularityArray.containsKey(myParams.getPopularity())){
                String popularityId = myPopularityArray.get(myParams.getPopularity());
                stringBuilder.append(popularityId);
            }
